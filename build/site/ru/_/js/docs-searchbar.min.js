    ...
    var t = {
        ...
        312: (t, e, n) => {
          ...
          function l(t) {
            ...
            ((t = t || {}).templates = t.templates || {}),
              ...
              (this.displayFn =
                ((r = (r = t.display || t.displayKey) || "value"),
                o.isFunction(r)
                  ? r
                  : function(t) {
                      return t[r];
              ...
              (this.templates =
                ...
                (i = this.displayFn),
                {
                  empty: n.empty && o.templatify(n.empty),
                  header: n.header && o.templatify(n.header),
                  footer: n.footer && o.templatify(n.footer),
                  suggestion:
                    n.suggestion ||
                    function(t) {
                      return "<p>" + i(t) + "</p>";
            ...
            (this.$el =
              t.$menu && t.$menu.find(s + "-" + this.name).length > 0
                ? a.element(t.$menu.find(s + "-" + this.name)[0])
                : a.element(
                    u.dataset
              ...
              _render: function(t, e) {
                if (this.$el) {
                  ...
                  if (
                    ...
                    this.$el
                      .html(l.apply(this, h))
                      .prepend(c.templates.header ? d.apply(this, h) : null)
                      .append(c.templates.footer ? f.apply(this, h) : null);
                  else if (n)
                    this.$el
                      .html(p.apply(this, h))
                      .prepend(c.templates.header ? d.apply(this, h) : null)
                ...
                function p() {
                  ...
                  function d(t) {
                    var e,
                      n = u.suggestion
                        .replace("%PREFIX%", l.cssClasses.prefix)
                        .replace("%SUGGESTION%", l.cssClasses.suggestion);
                    return (
                      (e = a
                        .element(n)
                        .attr({
                        ...
                        .append(
                          c.templates.suggestion.apply(this, [t].concat(h))
                        )).data(i, c.name),
                      e.data(r, c.displayFn(t) || void 0),
                      e.data(s, JSON.stringify(t)),
                      e.children().each(function() {
                        a.element(this).css(l.css.suggestionChild);
                      }),
                      e
                    );
                  }
        ...
        445: (t, e, n) => {
          ...
          i.mixin(u.prototype, s, {
            ...
            _getCursor: function() {
              return this.$menu
                .find(
                  i.className(this.cssClasses.prefix, this.cssClasses.cursor)
                )
                .first();
            },
        ...
        368: (t, e, n) => {
          ...
          i.mixin(s.prototype, {
            trigger: function(t, e, n, r) {
              var s = i.Event("autocomplete:" + t);
              return this.$el.trigger(s, [e, n, r]), s;
            }
          }),
            (t.exports = s);
        },
        823: (t, e, n) => {
          ...
          t.exports = {
            ...
            off: function(t) {
              ...
              for (t = t.split(r); (e = t.shift()); ) delete this._callbacks[e];
              return this;
            },
            trigger: function(t) {
              var e, n, s, a, u;
              if (!this._callbacks) return this;
              for (
                t = t.split(r), s = [].slice.call(arguments, 1);
        ...
        286: (t, e, n) => {
          ...
          function a(t) {
            var e,
              ...
              u,
              c = this;
            (t = t || {}).input || r.error("input is missing"),
              (e = r.bind(this._onBlur, this)),
          ...
          (a.normalizeQuery = function(t) {
            ...
            r.mixin(a.prototype, o, {
              ...
              _checkInputValue: function() {
                var t, e, n, i, r;
                (i = t = this.getInputValue()),
                  (r = this.query),
                  (n =
                    !(
                      !(e = a.normalizeQuery(i) === a.normalizeQuery(r)) ||
                      !this.query
        ...
        520: (t, e, n) => {
          ...
          function l(t) {
            ...
            (this.css = t.css = r.mixin({}, h, t.appendTo ? h.appendTo : {})),
              (this.cssClasses = t.cssClasses = r.mixin(
                {},
                h.defaultClasses,
                t.cssClasses || {}
              )),
              (this.cssClasses.prefix = t.cssClasses.formattedPrefix = r.formatPrefix(
                this.cssClasses.prefix,
                this.cssClasses.noPrefix
              )),
            ...
            var a = (function(t) {
              ...
              (o = s
                ...
                t.templates &&
                  ...
                  o.html(r.templatify(t.templates.dropdownMenu)()),
                (a = e
                  .clone()
                  .css(t.css.hint)
                  .css(
              ...
              return (
                (n = t.appendTo
                  ? n.appendTo(s.element(t.appendTo).eq(0)).eq(0)
                  : e.wrap(n).parent())
            ...
            (e = a.menu),
              ...
              (this.input = new l.Input({ input: u, hint: n })
          ...
          r.mixin(l.prototype, {
            _bindKeyboardShortcuts: function(t) {
              if (t.keyboardShortcuts) {
                ...
                r.each(t.keyboardShortcuts, function(t) {
                  ...
                  s.element(document).keydown(function(t) {
            ...
            _onEnterKeyed: function(t, e) {
              ...
              n
                ? (this._select(n, r), e.preventDefault())
                : this.autoselect &&
                  i &&
                  (this._select(i, r), e.preventDefault());
            },
              ...
              (e = this.input.getHint()),
                ...
                e &&
                  ...
                  ((r = this.dropdown.getDatumForTopSuggestion()) &&
                    this.input.setInputValue(r.value),
        ...
        670: (t, e, n) => {
          ...
          t.exports = {
            ...
            every: function(t, e) {
              var n = !0;
              return t
                ? (this.each(t, function(i, r) {
                    n && (n = e.call(null, i, r, t) && n);
                  }),
                  !!n)
                : n;
            },
            any: function(t, e) {
              ...
              return t
                ? (this.each(t, function(i, r) {
                    if (e.call(null, i, r, t)) return (n = !0), !1;
                  }),
                  n)
                : n;
            },
            ...
            escapeHighlightedString: function(t, e, n) {
              ...
              return (
                ...
                o.innerHTML
                  .replace(RegExp(s(i.innerHTML), "g"), e)
                  .replace(RegExp(s(r.innerHTML), "g"), n)
              );
            }
          };
        },
        683: (t, e, n) => {
          ...
          var i,
            ...
            u =
              ((i = []),
              (r = window.Promise.resolve()),
              function(t, e) {
                return function(n, o) {
                  var a, u;
                  ((a = t.as),
                  (u =
                    i.push({ indexName: t.indexName, query: n, params: e }) -
                    1),
                  window.Promise.resolve()
                    .then(function() {
                      return i.length && ((r = a.search(i)), (i = [])), r;
                    })
                    .then(function(t) {
                      if (t) return t.results[u];
                    }))
                    .then(function(t) {
                      t && o(t.hits, t);
                    })
        ...
        331: (t, e, n) => {
          "use strict";
          t.exports = { hits: n(683), popularIn: n(226) };
        },
        226: (t, e, n) => {
          "use strict";
          var i = n(670),
          ...
          t.exports = function(t, e, n, o) {
            ...
            if (
              (a &&
                a[0] >= 3 &&
                a[1] > 20 &&
                ((e = e || {}).additionalUA = "autocomplete.js " + r),
              !n.source)
            )
                    ...
                    if (a.hits.length > 0) {
                      ...
                      return (
                        d &&
                          d[0] >= 3 &&
                          d[1] > 20 &&
                          (e.additionalUA = "autocomplete.js " + r),
                        void c.search(u(l), p, function(t, e) {
                          if (t) i.error(t.message);
                          else {
                            var n = [];
                            if (o.includeAll) {
        ...
        281: (t, e, n) => {
              ...
              var c = i(r),
                ...
                l =
                  ...
                  new o({
                    ...
                    ariaLabel: e.ariaLabel || r.getAttribute("aria-label")
                  });
              c.data(s, l);
            });
            return (
          ...
          (u.sources = o.sources),
            (u.escapeHighlightedString = r.escapeHighlightedString);
          var c = "autocomplete" in window,
            h = window.autocomplete;
          (u.noConflict = function() {
            return (
              c ? (window.autocomplete = h) : delete window.autocomplete, u
            );
          }),
            (t.exports = u);
        },
            ...
            (t.exports = (function(t) {
                ...
                i = (function() {
                  ...
                  return (
                    ...
                    (O.fragment = function(t, n, r) {
                      var s, o, a;
                      return (
                        m.test(t) && (s = i(l.createElement(RegExp.$1))),
                        s ||
                          (t.replace && (t = t.replace(g, "<$1></$2>")),
                          n === e && (n = v.test(t) && RegExp.$1),
                          n in C || (n = "*"),
                          ((a = C[n]).innerHTML = "" + t),
                          (s = i.each(h.call(a.childNodes), function() {
                            a.removeChild(this);
                          }))),
                        $(r) &&
                          ((o = i(s)),
                    ...
                    (O.init = function(t, n) {
                      ...
                      if (!t) return O.Z();
                      if ("string" == typeof t)
                        if ("<" == (t = t.trim())[0] && v.test(t))
                          (r = O.fragment(t, RegExp.$1, n)), (t = null);
                        else {
                          if (n !== e) return i(n).find(t);
                          r = O.qsa(l, t);
                        }
                      else {
                        if (I(t)) return i(l).ready(t);
                        if (O.isZ(t)) return t;
                        if (R(t))
                          (s = t),
                            (r = c.call(s, function(t) {
                              return null != t;
                            }));
                        else if (N(t)) (r = [t]), (t = null);
                        else if (v.test(t))
                          (r = O.fragment(t.trim(), RegExp.$1, n)), (t = null);
                        else {
                          if (n !== e) return i(n).find(t);
                          r = O.qsa(l, t);
                        }
                    ...
                    (i.map = function(t, e) {
                      ...
                      else for (s in t) null != (n = e(t[s], s)) && a.push(n);
                      return (o = a).length > 0 ? i.fn.concat.apply([], o) : o;
                    }),
                    (i.each = function(t, e) {
                      var n, i;
                      if (L(t)) {
                    ...
                    (i.fn = {
                      ...
                      closest: function(t, e) {
                        ...
                        return (
                          this.each(function(i, s) {
                            for (
                              ;
                              s && !(r ? r.indexOf(s) >= 0 : O.matches(s, t));

                            )
                              s = s !== e && !P(s) && s.parentNode;
                      ...
                      parent: function(t) {
                        return K(o(this.pluck("parentNode")), t);
                      },
                      children: function(t) {
                        return K(
                          this.map(function() {
                      ...
                      contents: function() {
                        return this.map(function() {
                          return (
                            this.contentDocument || h.call(this.childNodes)
                          );
                        });
                      },
                      siblings: function(t) {
                        return K(
                          this.map(function(t, e) {
                            return c.call(B(e.parentNode), function(t) {
                              return t !== e;
                            });
                          }),
                          t
                      ...
                      wrap: function(t) {
                        ...
                        return this.each(function(s) {
                          i(this).wrapAll(
                            e ? t.call(this, s) : r ? n.cloneNode(!0) : n
                          );
                        });
                      },
                      wrapAll: function(t) {
                      ...
                      next: function(t) {
                        return i(this.pluck("nextElementSibling")).filter(
                          t || "*"
                        );
                      },
                      html: function(t) {
                      ...
                      attr: function(t, i) {
                        ...
                        return "string" != typeof t || 1 in arguments
                          ? this.each(function(e) {
                              if (1 === this.nodeType)
                                if (N(t)) for (n in t) W(this, n, t[n]);
                                else
                                  W(
                                    this,
                                    t,
                                    z(this, i, e, this.getAttribute(t))
                                  );
                            })
                          : 0 in this &&
                            1 == this[0].nodeType &&
                          ...
                          if (R(t)) {
                            ...
                            return (
                              i.each(t, function(t, e) {
                                o[e] = r.style[s(e)] || a.getPropertyValue(e);
                              }),
                              o
                            );
                          }
                      ...
                      position: function() {
                        if (this.length) {
                          ...
                          return (
                            ...
                            (n.left -=
                              parseFloat(i(t).css("margin-left")) || 0),
                            (r.top +=
                              parseFloat(i(e[0]).css("border-top-width")) || 0),
                            (r.left +=
                              parseFloat(i(e[0]).css("border-left-width")) ||
                              0),
                    ...
                    ["after", "prepend", "before", "append"].forEach(function(
                      ...
                      (i.fn[n] = function() {
                              ...
                              (o = s ? n : n.parentNode),
                                (n =
                                  0 == r
                                    ...
                                    ? n
                                    : null);
                              var c = i.contains(l.documentElement, o);
                        ...
                        (i.fn[
                          s ? n + "To" : "insert" + (r ? "Before" : "After")
                        ] = function(t) {
                          return i(t)[n](this), this;
                        });
                    }),
                    (O.Z.prototype = U.prototype = i.fn),
                    (O.uniq = o),
                    (O.deserializeValue = G),
                    (i.zepto = O),
                    i
                  );
                })();
              return (
                (function(e) {
                  ...
                  function v(t, e) {
                    return (t.del && !c && t.e in h) || !!e;
                  }
                  function m(t) {
                    return l[t] || (c && h[t]) || t;
                  }
                  function g(t, i, r, s, o, u, c) {
                    var h = p(t),
                      d = a[h] || (a[h] = []);
                    i.split(/\s/).forEach(function(i) {
                      if ("ready" == i) return e(document).ready(r);
                      var a = f(i);
                      (a.fn = r),
                        (a.sel = o),
                        a.e in l &&
                      ...
                      (a.proxy = function(e) {
                        ...
                        "addEventListener" in t &&
                          t.addEventListener(m(a.e), a.proxy, v(a, c));
                    });
                  }
                      ...
                      d(t, e, n, i).forEach(function(e) {
                        delete a[s][e.i],
                          "removeEventListener" in t &&
                            t.removeEventListener(m(e.e), e.proxy, v(e, r));
                      });
                    });
                  }
                    ...
                    (e.proxy = function(t, n) {
                      ...
                      if (s(t)) {
                        var a = function() {
                          return t.apply(
                            n,
                            i ? i.concat(r.call(arguments)) : arguments
                          );
                        };
                        return (a._zid = p(t)), a;
                      }
                        ...
                        : (o(i) ||
                          ...
                          p.each(function(n, s) {
                            c &&
                              (h = function(t) {
                                return (
                                  y(s, t.type, u), u.apply(this, arguments)
                                );
                              }),
                              i &&
                                (l = function(t) {
                      ...
                      return (
                        ((t =
                          o(t) || e.isPlainObject(t)
                            ...
                            : C(t))._args = n),
                        this.each(function() {
                          t.type in h && "function" == typeof this[t.type]
                            ? this[t.type]()
                      ...
                      return (
                        this.each(function(s, a) {
                          ((i = E(o(t) ? e.Event(t) : t))._args = n),
                            (i.target = a),
                            e.each(d(a, t.type || t), function(t, e) {
                              if (
                                ((r = e.proxy(i)),
                ...
                (function(t) {
                  var e = {},
                    ...
                    s = [];
                  function o(n, o, a) {
                    var u = n[r] || (n[r] = ++t.uuid),
                      c =
                        e[u] ||
                        (e[u] = (function(e) {
                          var n = {};
                          return (
                            t.each(e.attributes || s, function(e, r) {
                              0 == r.name.indexOf("data-") &&
                                (n[
                                  i(r.name.replace("data-", ""))
                                ] = t.zepto.deserializeValue(r.value));
                            }),
                            n
                          );
                        })(n));
                    return void 0 !== o && (c[i(o)] = a), c;
                  }
        ...
        624: (t, e, n) => {
          ...
          var i,
            r,
            s,
            o = [n(525), n(785), n(291), n(709), n(506), n(176)],
            a = -1,
            u = [],
            c = !1;
          function h() {
            i &&
              r &&
              ((i = !1),
              r.length ? (u = r.concat(u)) : (a = -1),
              u.length && l());
          }
          function l() {
            if (!i) {
              (c = !1), (i = !0);
              for (var t = u.length, e = setTimeout(h); t; ) {
                for (r = u, u = []; r && ++a < t; ) r[a].run();
                (a = -1), (t = u.length);
              }
              (r = null), (a = -1), (i = !1), clearTimeout(e);
            }
          }
        ...
        229: function(t, e, n) {
          !(function(t) {
            ...
            var o = (function(t) {
                function e(n, i, r, s) {
                  var o,
                    ...
                    c = this;
                  return (
                    ((c = t.call(this, n) || this).name =
                      "MeiliSearchCommunicationError"),
                    (c.type = "MeiliSearchCommunicationError"),
                    i instanceof Response &&
                      ((c.message = i.statusText), (c.statusCode = i.status)),
                    i instanceof Error &&
                      ((c.errno = i.errno), (c.code = i.code)),
                    s
                      ? ((c.stack = s),
                        (c.stack =
                          null === (o = c.stack) || void 0 === o
                            ? void 0
                            : o.replace(/(TypeError|FetchError)/, c.name)),
                        (c.stack =
                        ...
                        (c.stack =
                          null === (u = c.stack) || void 0 === u
                            ? void 0
                            : u.replace("Not Found", "Not Found: ".concat(r))))
              ...
              a = (function(t) {
                function e(e, n) {
                  var i = t.call(this, e.message) || this;
                  return (
                    (i.name = "MeiliSearchApiError"),
                    (i.code = e.code),
                    (i.type = e.type),
                    (i.link = e.link),
                    (i.message = e.message),
                ...
                return s(this, function(n) {
                  switch (n.label) {
                    ...
                    case 2:
                      return (e = n.sent()), [3, 4];
                    case 3:
                      throw (n.sent(), new o(t.statusText, t, t.url));
                    case 4:
            ...
            function c(t, e, n) {
              if ("MeiliSearchApiError" !== t.type)
                throw new o(t.message, t, n, e);
              throw t;
            }
            var h = (function(t) {
                function e(n) {
                  ...
                  return (
                    (i.name = "MeiliSearchError"),
                    (i.type = "MeiliSearchError"),
              ...
              l = (function(t) {
                function e(n) {
                  var i = t.call(this, n) || this;
                  return (
                    (i.name = "MeiliSearchTimeOutError"),
                    (i.type = i.constructor.name),
                    Error.captureStackTrace && Error.captureStackTrace(i, e),
                    i
                  );
                }
            ...
            var m = (function() {
                function t(t) {
                  (this.headers = Object.assign({}, t.headers || {})),
                    (this.headers["Content-Type"] = "application/json"),
                    t.apiKey &&
                      (this.headers.Authorization = "Bearer ".concat(t.apiKey));
                  try {
                    var e = (function(t) {
                      try {
                        return v((t = f(t)));
                ...
                return (
                  ...
                  (t.prototype.put = function(t, e, n, i) {
                    return r(this, void 0, void 0, function() {
                      return s(this, function(r) {
                        switch (r.label) {
                          case 0:
                  ...
                  (t.prototype.patch = function(t, e, n, i) {
                    return r(this, void 0, void 0, function() {
                      return s(this, function(r) {
                        switch (r.label) {
                          case 0:
                  ...
                  (t.prototype.delete = function(t, e, n, i) {
                    return r(this, void 0, void 0, function() {
                      return s(this, function(r) {
                        switch (r.label) {
                          case 0:
              ...
              g = (function() {
                function t(t) {
                  this.httpRequest = new m(t);
                }
                return (
                  (t.prototype.getClientTask = function(t) {
                    return r(this, void 0, void 0, function() {
                      var e;
                      return s(this, function(n) {
                        switch (n.label) {
                  ...
                  (t.prototype.getClientTasks = function() {
                    return r(this, void 0, void 0, function() {
                      return s(this, function(t) {
                        switch (t.label) {
                          case 0:
                            return "tasks", [4, this.httpRequest.get("tasks")];
                          case 1:
                            return [2, t.sent()];
                        }
                      });
                  ...
                  (t.prototype.getIndexTask = function(t, e) {
                    return r(this, void 0, void 0, function() {
                      var n;
                      return s(this, function(i) {
                        switch (i.label) {
                          case 0:
                            return (
                              (n = "indexes/".concat(t, "/tasks/").concat(e)),
                              [4, this.httpRequest.get(n)]
                            );
                          case 1:
                            return [2, i.sent()];
                        }
                  ...
                  (t.prototype.getIndexTasks = function(t) {
                    return r(this, void 0, void 0, function() {
                      var e;
                      return s(this, function(n) {
                        switch (n.label) {
                  ...
                  (t.prototype.waitForClientTask = function(t, e) {
                    var n = void 0 === e ? {} : e,
                      i = n.timeOutMs,
                      o = void 0 === i ? 5e3 : i,
                      a = n.intervalMs,
                    ...
                    return r(this, void 0, void 0, function() {
                      ...
                      return s(this, function(i) {
                        switch (i.label) {
                          case 0:
                            (e = Date.now()), (i.label = 1);
                          case 1:
                            return Date.now() - e < o
                              ? [4, this.getClientTask(t)]
                              : [3, 4];
                          case 2:
                            return (
                              (n = i.sent()),
                          ...
                          case 4:
                            throw new l(
                              "timeout of "
                                .concat(o, "ms has exceeded on process ")
                                .concat(
                                  t,
                  ...
                  (t.prototype.waitForClientTasks = function(t, e) {
                    var n = void 0 === e ? {} : e,
                      i = n.timeOutMs,
                      o = void 0 === i ? 5e3 : i,
                      a = n.intervalMs,
                  ...
                  (t.prototype.waitForIndexTask = function(t, e, n) {
                    var i = void 0 === n ? {} : n,
                      o = i.timeOutMs,
                      a = void 0 === o ? 5e3 : o,
                      u = i.intervalMs,
                    ...
                    return r(this, void 0, void 0, function() {
                      ...
                      return s(this, function(r) {
                        switch (r.label) {
                          case 0:
                            (n = Date.now()), (r.label = 1);
                          case 1:
                            return Date.now() - n < a
                              ? [4, this.getIndexTask(t, e)]
                              : [3, 4];
                          case 2:
                            return (
                              (i = r.sent()),
                              ["enqueued", "processing"].includes(i.status)
                                ? [4, d(c)]
                                : [2, i]
                            );
                          case 3:
              ...
              y = (function() {
                ...
                return (
                    ...
                    return r(this, void 0, void 0, function() {
                      ...
                      return s(this, function(s) {
                        switch (s.label) {
                          case 0:
                            return (
                              (r = "indexes/".concat(this.uid, "/search")),
                              [
                                4,
                        ...
                        switch (s.label) {
                          case 0:
                            return (
                              ...
                              (a = i(i({ q: t }, e), {
                                filter: o(null == e ? void 0 : e.filter),
                                sort: (null == e
                                ? void 0
                                : e.sort)
                                  ? e.sort.join(",")
                                  : void 0,
                                facetsDistribution: (null == e
                                ? void 0
                                : e.facetsDistribution)
                                  ? e.facetsDistribution.join(",")
                                  : void 0,
                                attributesToRetrieve: (null == e
                                ? void 0
                                : e.attributesToRetrieve)
                                  ? e.attributesToRetrieve.join(",")
                                  : void 0,
                                attributesToCrop: (null == e
                                ? void 0
                                : e.attributesToCrop)
                                  ? e.attributesToCrop.join(",")
                                  : void 0,
                                attributesToHighlight: (null == e
                                ? void 0
                                : e.attributesToHighlight)
                                  ? e.attributesToHighlight.join(",")
                                  : void 0
                              })),
                              [4, this.httpRequest.get(r, p(a), n)]
                            );
                          case 1:
                            return [2, s.sent()];
                        }
                      ...
                      r(this, void 0, void 0, function() {
                        return s(this, function(r) {
                          return (
                            ...
                            [
                              2,
                              new m(n).post("indexes", i(i({}, e), { uid: t }))
                            ]
                          );
                        });
                      })
                  ...
                  (t.prototype.getTask = function(t) {
                    return r(this, void 0, void 0, function() {
                      return s(this, function(e) {
                        switch (e.label) {
                          case 0:
                            return [4, this.tasks.getIndexTask(this.uid, t)];
                          case 1:
                            return [2, e.sent()];
                        }
                      });
                      ...
                      return s(this, function(e) {
                        switch (e.label) {
                          case 0:
                            return [
                              4,
                              this.tasks.waitForClientTasks(t, {
                                timeOutMs: o,
                                intervalMs: u
                              })
                            ];
                      ...
                      return s(this, function(e) {
                        switch (e.label) {
                          case 0:
                            return [
                              4,
                              this.tasks.waitForClientTask(t, {
                                timeOutMs: o,
                                intervalMs: u
                              })
                            ];
                        ...
                        switch (r.label) {
                          case 0:
                            return (
                              ...
                              void 0 !== t &&
                                Array.isArray(t.attributesToRetrieve) &&
                                (n = t.attributesToRetrieve.join(",")),
                              [
                                4,
                  ...
                  (t.prototype.getDocument = function(t) {
                    return r(this, void 0, void 0, function() {
                      var e;
                      return s(this, function(n) {
                        switch (n.label) {
                        ...
                        return s(this, function(s) {
                          switch (s.label) {
                            ...
                            case 1:
                              return r < t.length
                                ? ((a = (o = i).push),
                                  [4, this.addDocuments(t.slice(r, r + e), n)])
                                : [3, 4];
                            case 2:
                              a.apply(o, [s.sent()]), (s.label = 3);
                            case 3:
                              return (r += e), [3, 1];
                            case 4:
                              return [2, i];
                            ...
                            case 1:
                              return r < t.length
                                ? ((a = (o = i).push),
                                  [
                                    4,
                                    this.updateDocuments(t.slice(r, r + e), n)
                                  ])
                                : [3, 4];
                            case 2:
                              a.apply(o, [s.sent()]), (s.label = 3);
                ...
                (function() {
                  ...
                  return (
                    (t.prototype.index = function(t) {
                      return new y(this.config, t);
                    }),
                    (t.prototype.getIndex = function(t) {
                      return r(this, void 0, void 0, function() {
                        return s(this, function(e) {
                          return [2, new y(this.config, t).fetchInfo()];
                        });
                      });
                    }),
                    (t.prototype.getRawIndex = function(t) {
                      return r(this, void 0, void 0, function() {
                        return s(this, function(e) {
                          return [2, new y(this.config, t).getRawInfo()];
                        });
                      });
                    }),
                            ...
                            case 1:
                              return [
                                ...
                                e.sent().map(function(e) {
                                  return new y(t.config, e.uid, e.primaryKey);
                                })
                              ];
                          }
                        });
                    ...
                    (t.prototype.getRawIndexes = function() {
                      return r(this, void 0, void 0, function() {
                        return s(this, function(t) {
                          switch (t.label) {
                            case 0:
                              return (
                                "indexes", [4, this.httpRequest.get("indexes")]
                              );
                            case 1:
                              return [2, t.sent()];
                          }
                      ...
                      return (
                        ...
                        r(this, void 0, void 0, function() {
                          return s(this, function(n) {
                            switch (n.label) {
                              case 0:
                                return [4, y.create(t, e, this.config)];
                              case 1:
                                return [2, n.sent()];
                            }
                          });
                      ...
                      return (
                        ...
                        r(this, void 0, void 0, function() {
                          return s(this, function(n) {
                            switch (n.label) {
                              case 0:
                                return [4, new y(this.config, t).update(e)];
                              case 1:
                                return [2, n.sent()];
                            }
                          });
                    ...
                    (t.prototype.deleteIndex = function(t) {
                      return r(this, void 0, void 0, function() {
                        return s(this, function(e) {
                          switch (e.label) {
                            case 0:
                              return [4, new y(this.config, t).delete()];
                            case 1:
                              return [2, e.sent()];
                          }
                        });
                    ...
                    (t.prototype.getTask = function(t) {
                      return r(this, void 0, void 0, function() {
                        return s(this, function(e) {
                          switch (e.label) {
                            case 0:
                              return [4, this.tasks.getClientTask(t)];
                            case 1:
                              return [2, e.sent()];
                          }
                        });
                    ...
                    (t.prototype.getKeys = function() {
                      return r(this, void 0, void 0, function() {
                        return s(this, function(t) {
                          switch (t.label) {
                            case 0:
                              return "keys", [4, this.httpRequest.get("keys")];
                            case 1:
                              return [2, t.sent()];
                          }
                        });
                      ...
                      return r(this, void 0, void 0, function() {
                        return s(this, function(e) {
                          switch (e.label) {
                            case 0:
                              return (
                                "keys", [4, this.httpRequest.post("keys", t)]
                              );
                            case 1:
                              return [2, e.sent()];
                          }
                      ...
                      return r(this, void 0, void 0, function() {
                        return s(this, function(t) {
                          switch (t.label) {
                            case 0:
                              return (
                                "health", [4, this.httpRequest.get("health")]
                              );
                            case 1:
                              return [2, t.sent()];
                          }
                      ...
                      return r(this, void 0, void 0, function() {
                        return s(this, function(t) {
                          switch (t.label) {
                            case 0:
                              return (
                                "stats", [4, this.httpRequest.get("stats")]
                              );
                            case 1:
                              return [2, t.sent()];
                          }
                      ...
                      return r(this, void 0, void 0, function() {
                        return s(this, function(t) {
                          switch (t.label) {
                            case 0:
                              return (
                                "version", [4, this.httpRequest.get("version")]
                              );
                            case 1:
                              return [2, t.sent()];
                          }
                      ...
                      return r(this, void 0, void 0, function() {
                        return s(this, function(t) {
                          switch (t.label) {
                            case 0:
                              return (
                                "dumps", [4, this.httpRequest.post("dumps")]
                              );
                            case 1:
                              return [2, t.sent()];
                          }
                    ...
                    (t.prototype.getDumpStatus = function(t) {
                      return r(this, void 0, void 0, function() {
                        var e;
                        return s(this, function(n) {
                          switch (n.label) {
                    ...
                    (t.prototype.generateTenantToken = function(t, e) {
                      var n = new Error();
                      throw new Error(
            ...
            (t.HttpRequests = m),
              ...
              (t.MeiliSearchCommunicationError = o),
              (t.MeiliSearchError = h),
              (t.MeiliSearchTimeOutError = l),
              (t.addProtocolIfNotPresent = f),
              (t.addTrailingSlash = v),
              (t.default = b),
              (t.httpErrorHandler = c),
              (t.httpResponseErrorHandler = u),
              (t.removeUndefinedFromObject = p),
              (t.sleep = d),
          ...
          t.exports = function(t) {
            var n = function() {
              for (var n = arguments.length, i = Array(n), r = 0; r < n; r++)
                i[r] = arguments[r];
              return new (e.apply(t, [null].concat(i)))();
            };
            return (n.__proto__ = t), (n.prototype = t.prototype), n;
          };
        },
        525: () => {}
      },
      ...
      (() => {
        ...
        const c = {
          suggestion: function(t) {
            return '\n  <a class="'
              .concat(a, "\n    ")
              .concat(
                t.isCategoryHeader ? "".concat(a, "__main") : "",
                "\n    "
              )
              .concat(
                t.isSubCategoryHeader ? "".concat(a, "__secondary") : "",
                '\n    "\n    aria-label="Link to the result"\n    href="'
              )
              .concat(t.url, '"\n    >\n    <div class="')
              .concat(a, '--category-header">\n      <span class="')
              .concat(a, '--category-header-lvl0">\n        ')
              .concat(
                t.category,
                '\n      </span>\n    </div>\n    <div class="'
              )
              .concat(a, '--wrapper">\n      <div class="')
              .concat(a, '--subcategory-column">\n        <span class="')
              .concat(a, '--subcategory-column-text">\n          ')
              .concat(t.subcategory, "\n        </span>\n      </div>\n      ")
              .concat(
                t.isTextOrSubcategoryNonEmpty
                  ? '\n        <div class="'
                      .concat(a, '--content">\n          <div class="')
                      .concat(a, '--subcategory-inline">\n            ')
                      .concat(
                        t.subcategory,
                        '\n          </div>\n          <div class="'
                      )
            ...
            return '\n  <div class="'
              ...
              .concat(
                t.isLvl0
                  ...
                  : '\n            <span class="'
                      .concat(a, "--category-header-lvl0 ")
                      .concat(a, '--category-header-item">\n                ')
                      .concat(t.category, "\n            </span>\n            ")
                      .concat(
                        t.isLvl1 || t.isLvl1EmptyOrDuplicate
                          ? ""
                          : '\n            <span class="'
                              .concat(a, "--category-header-lvl1 ")
                              .concat(
                                a,
          ...
          empty: function(t) {
            ...
            return '\n  <div class="'
              ...
              .concat(
                a,
                '--text">\n                Ничего не найдено по запросу <b>"'
              )
              .concat(
                t.query,
                '"</b>\n                </div>\n            </div>\n        </div>\n    </div>\n  </div>\n  '
        ...
        const d = {
          mergeKeyWithParent: function(t, e) {
            ...
            if ("object" !== p(t[e])) return t;
            var n = l.extend({}, t, t[e]);
            return delete n[e], n;
          },
          renameKeysWithLevels: function(t, e) {
            return Object.keys(t).reduce(function(n, i) {
              var r = n;
              return (
                i.startsWith(e)
                  ? (r[i.substring(i.indexOf("lvl"))] = t[i])
                  : (r[i] = t[i]),
                r
              );
            }, {});
          },
          replaceNullString: function(t) {
            return Object.keys(t).reduce(function(e, n) {
              var i = e;
              return (
                "string" == typeof t[n] && "null" === t[n]
                  ? (i[n] = null)
                  : (i[n] = t[n]),
                i
              );
          ...
          groupBy: function(t, e) {
            ...
            return (
              l.each(t, function(t, i) {
                if (void 0 === i[e])
                  throw new Error("[groupBy]: Object has no key ".concat(e));
                var r = i[e];
          ...
          getHighlightedValue: function(t, e) {
            return t._formatted &&
              t._formatted[e] &&
              "string" == typeof t._formatted[e]
              ? this.replaceHtmlTagsToHighlight(t._formatted[e])
              : t[e];
          },
          replaceHtmlTagsToHighlight: function(t) {
            return t
              .replace(
                /<em>/g,
                '<span class="docs-searchbar-suggestion--highlight">'
              )
              .replace(/<\/em>/g, "</span>");
          },
          getSnippetedValue: function(t, e) {
            if (
              ...
              return t[e];
            var n = this.replaceHtmlTagsToHighlight(t._formatted[e]);
            return (
              n[0] !== n[0].toUpperCase() && (n = "…".concat(n)),
        ...
        const w = (function() {
          function t(e) {
            var n = e.hostUrl,
              ...
              a = e.debug,
              u = void 0 !== a && a,
              h = e.meilisearchOptions,
              p = void 0 === h ? {} : h,
              d = e.queryDataCallback,
              v = void 0 === d ? null : d,
              ...
              C = e.handleSelected,
              E = void 0 !== C && C,
              _ = e.enhancedSearchInput,
              k = void 0 !== _ && _,
              T = e.layout,
              O = void 0 === T ? "columns" : T,
              A = e.enableDarkMode,
              D = void 0 !== A && A;
            !(function(t, e) {
              if (!(t instanceof e))
              ...
              t.checkArguments({
                ...
                inputSelector: o,
                debug: u,
                meilisearchOptions: p,
                queryDataCallback: v,
                autocompleteOptions: y,
                transformData: w,
                queryHook: S,
                handleSelected: E,
                enhancedSearchInput: k,
                layout: O,
                enableDarkMode: D
              }),
              (this.apiKey = i),
              (this.hostUrl = n),
              (this.indexUid = r),
              (this.input = t.getInputFromSelector(o)),
              (this.meilisearchOptions = g(
                {
                  limit: 100,
              ...
              (this.queryDataCallback = v || null),
              (this.autocompleteOptions = g(
                { debug: u, hint: !1, autoselect: !0 },
                y
              ));
            var R =
              this.input &&
            ...
            (this.autocompleteOptions.ariaLabel =
              this.autocompleteOptions.ariaLabel || R || "search input"),
              ...
              (this.isSimpleLayout = "simple" === O),
              (this.enableDarkMode = D),
              (this.client = new f.MeiliSearch({
                host: n,
                apiKey: this.apiKey
              })),
              t.addThemeWrapper(o, this.enableDarkMode),
              k && (this.input = t.injectSearchBox(this.input)),
              (this.autocomplete = s()(this.input, this.autocompleteOptions, [
                {
                  source: this.getAutocompleteSource(w, S),
                  templates: {
            ...
            var q = E;
            (this.handleSelected = q || this.handleSelected),
              q &&
                l(".meilisearch-autocomplete").on(
                  "click",
                  ".".concat(
                    this.autocompleteOptions.cssClasses.prefix,
                    "-suggestions a"
            ...
            (i = [
              {
                ...
                value: function(t, e) {
                  ...
                  (r.className += "docs-searchbar-js"),
                    i.replaceChild(r, n),
                    r.appendChild(n);
                  var s = Boolean(e);
                  if ("auto" === e && window.matchMedia) {
                    ...
                    var a = function t(e) {
                      document.body.contains(r)
                        ...
                        : o.removeListener && o.removeListener(t);
                    };
                    o.addEventListener
                      ? o.addEventListener("change", a)
                      : o.addListener && o.addListener(a);
                  }
                  r.setAttribute("data-ds-theme", s ? "dark" : "light");
                }
              },
              {
                key: "checkArguments",
                value: function(e) {
                  if (!e.inputSelector || !e.indexUid || !e.hostUrl)
                    throw new Error(
                      "Usage:\n  documentationSearch({\n  hostUrl,\n  apiKey,\n  indexUid,\n  inputSelector,\n  [ debug ],\n  [ meilisearchOptions ],\n  [ queryDataCallback ],\n  [ autocompleteOptions ],\n  [ transformData ],\n  [ queryHook ],\n  [ handleSelected ],\n  [ enhancedSearchInput ],\n  [ layout ],\n  [ enableDarkMode ]\n})"
                    );
                  if ("string" != typeof e.inputSelector)
                    throw new Error(
                      "Error: inputSelector:".concat(
                        e.inputSelector,
                  ...
                  if (!t.getInputFromSelector(e.inputSelector))
                    throw new Error(
                      "Error: No input element in the page matches ".concat(
                        e.inputSelector
                      )
                    );
                  if (
                    ...
                    "auto" !== e.enableDarkMode &&
                      !1 !== e.enableDarkMode &&
                      !0 !== e.enableDarkMode)
                  )
                    throw new Error(
                      "Error: \"enableDarkMode\" must be either true, false, or 'auto'. Supplied value: ".concat(
                        e.enableDarkMode
                      )
                    );
                  if (
                    ...
                    e.layout && !["simple", "columns"].includes(e.layout))
                  )
                    throw new Error(
                      "Error: \"layout\" must be either 'columns' or 'simple'. Supplied value: ".concat(
                        e.layout
                      )
                    );
                }
              ...
              },
              {
                ...
                value: function() {
                  l('.searchbox [type="reset"]').on("click", function() {
                    l("input#docs-searchbar").focus(),
                      l(this).addClass("hide"),
                      s().autocomplete.setVal("");
                  }),
                    l("input#docs-searchbar").on("keyup", function() {
                      var t = document.querySelector("input#docs-searchbar"),
                        e = document.querySelector('.searchbox [type="reset"]');
                      (e.className = "searchbox__reset"),
                        0 === t.value.length && (e.className += " hide");
                    });
                }
              },
              {
              ...
              },
              {
                key: "formatHits",
                value: function(e) {
                  var n = d.deepClone(e).map(function(t) {
                      if (t._formatted) {
                        var e = d.replaceNullString(t._formatted);
                        t._formatted = d.renameKeysWithLevels(e, "hierarchy_");
                      }
                      var n = d.replaceNullString(t);
                      return d.renameKeysWithLevels(n, "hierarchy_");
                    }),
                    i = d.groupBy(n, "lvl0");
                  return (
                    l.each(i, function(t, e) {
                      var n = d.groupBy(e, "lvl1"),
                        r = d.flattenAndFlagFirst(n, "isSubCategoryHeader");
                      i[t] = r;
                    }),
                    (i = d.flattenAndFlagFirst(i, "isCategoryHeader")).map(
                      function(e) {
                        var n = t.formatURL(e),
                          i = d.getHighlightedValue(e, "lvl0"),
                          r = d.getHighlightedValue(e, "lvl1") || i,
                          s = d
                            .compact([
                              d.getHighlightedValue(e, "lvl2") || r,
                              d.getHighlightedValue(e, "lvl3"),
                              d.getHighlightedValue(e, "lvl4"),
                              d.getHighlightedValue(e, "lvl5"),
                              d.getHighlightedValue(e, "lvl6")
                            ])
                            .join(
                              '<span class="aa-suggestion-title-separator" aria-hidden="true"> › </span>'
                            ),
                          o = d.getSnippetedValue(e, "content"),
                          a = (r && "" !== r) || (s && "" !== s),
                          u = s && "" !== s && s !== r,
                          c = !u && r && "" !== r && r !== i;
                        return {
                          ...
                          isLvl1: c,
                          isLvl2: u,
                          isLvl1EmptyOrDuplicate: !r || "" === r || r === i,
              ...
              },
              {
                ...
                value: function(t) {
                  return t ? c.suggestionSimple : c.suggestion;
                }
              }
            ]),
            (n = [
                ...
                value: function(e, n) {
                  ...
                  return function(r, s) {
                    n && (r = n(r) || r),
                      i.client
                        .index(i.indexUid)
                        .search(r, i.meilisearchOptions)
                        .then(function(n) {
                          i.queryDataCallback &&
                            "function" == typeof i.queryDataCallback &&
                            i.queryDataCallback(n);
                          var r = n.hits;
                          e && (r = e(r) || r), s(t.formatHits(r));
                        });
                  };
                }
              },
                  ...
                  var i =
                    ...
                    r =
                      e - n < 0
                        ? "meilisearch-autocomplete-right"
                        : "meilisearch-autocomplete-left",
                    s = l(".meilisearch-autocomplete");
                  s.hasClass(i) || s.addClass(i),
                    s.hasClass(r) && s.removeClass(r);
                }
              },
              {
